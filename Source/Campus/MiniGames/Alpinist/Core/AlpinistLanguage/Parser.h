...
namespace AlpinistGame
{
	...
	inline CommandT* Parser::CreateCommandWithCondtion(const std::string& Command, MacroCommand* commandList, bool& CommandHasCondition)
	{
	...
	template<typename CommandType>
	inline bool Parser::FillScope(CommandType* Command, void(CommandType::* PushCommand)(PlayerCommand*), const bool HasCondition)
	{
